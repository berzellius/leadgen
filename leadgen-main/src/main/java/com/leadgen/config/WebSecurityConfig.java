...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeRequests()
                .antMatchers("/", "/index", "/rest/order/add", "/rest/order/addjs").permitAll()
                .antMatchers("/orders/**").hasAnyAuthority("ADMIN","CLIENT","MANAGER")
                .antMatchers("/clients/**", "/order_src/**", "/utm/**", "/utm/price/**").hasAnyAuthority("ADMIN")
